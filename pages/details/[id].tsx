      ...
      <Box my={20} p={10}>
        ...
        <Box p={5} border="solid 2px teal" borderRadius={25} my={5}>
          ...
          <SimpleGrid columns={{ base: 2, md: 2 }} spacing={4}>
            ...
            <Text my={2}>Pressure: {props.city.main.pressure} hPa </Text>
          ...
          >
            {props.dailyForecast.daily.map((dailyWeather) => (
              <Box key={dailyWeather.dt}>
                ...
                <Text>Min Temp: {dailyWeather.temp.min.toFixed(0)}°C</Text>
                <Text>Forecast: {dailyWeather.weather[0].description}</Text>
                <Image
